...
public class SimilarityAssessor {
	...
	public static final String PIRRO_SECO_METRIC = "Pirrò and Seco";
	...
	public double getSenseSimilarity(String word1, int senseForWord1,
			String word2, int senseForWord2, String metric)
			throws WordNotFoundException {
	...
	private double getBestMSCAValue(Document doc1, Document doc2) {
		...
		LinkedList intersection = getIntersection(
				doc1.getValues(IndexBroker.HYPERNYM)[0].split(" "),
